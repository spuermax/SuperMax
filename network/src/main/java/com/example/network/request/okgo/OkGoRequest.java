package com.example.network.request.okgo;
...
public abstract class OkGoRequest implements IRequest{
    private static OkGoRequest request;
    private NetManager.Builder builder;
    public static IRequest create(NetManager.Builder builde){
        if (request == null){
            synchronized (String.class){
                if (request == null) {
                    request = new OkGoRequest(){};
